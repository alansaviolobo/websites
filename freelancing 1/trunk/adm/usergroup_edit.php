  ...
  <form action="usergroup_delete.php" method="post" name="f1" id="f1">
    ...
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td width="100" height="30"><span class="rowheader">Group Name</span></td>
        <td width="130" height="30" bgcolor="#FF9900"><span class="rowheader">Removable</span></td>
...
$query = "SELECT * FROM ".$config['db']['pre']."usergroups ".$limit;
...
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><? if($info['group_removable']){ ?><input type="hidden" name="titles[]" id="titles[]" value="<?php echo stripslashes($info['group_name']);?>"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['group_id'];?>"><? } ?></td>
        <td width="100" height="25"><span class="style5"><?php echo stripslashes($info['group_name']);?></span></td>
        <td height="25"><span class="style5"><?php if($info['group_removable']){ echo 'Yes'; } else { echo 'No'; } ?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['group_id'];?>" id="amenu<?php echo $info['group_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="usergroup_edit2.php?id=<?php echo $info['group_id'];?>">View/Edit Usergroup</option>
                  <? if($info['group_removable']){ ?><option value="usergroup_delete.php?id=<?php echo $info['group_id'];?>">Delete Usergroup</option><? } ?>
                </select>
</td>
			  </tr>
			  </table>
...
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onClick="document.f1.action='usergroup_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
