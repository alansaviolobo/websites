...
<html>
<head>
	<title><?php echo $config['site_title']; ?> Admin - Edit Job Types</title>
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Edit Job Types</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="jobtype_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td height="30"><span class="rowheader">Job Type Title</span></td>
      </tr>
      <tr bgcolor="#000000">
...
$query = "SELECT 1 FROM ".$config['db']['pre']."jobs_types";
...
$query = "SELECT type_id,type_title FROM ".$config['db']['pre']."jobs_types ORDER BY type_title ".$limit;
...
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value=""><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['type_id']; ?>"></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['type_title']);?></span></td>
      </tr>
      <?
}
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onclick="document.f1.action='jobtype_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
