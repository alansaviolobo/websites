...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		mysql_query("INSERT INTO `".$config['db']['pre']."rules` ( `rule_id` , `page` , `rule_title` , `rule_eregi` , `rule_msg` ) VALUES ('', '" . addslashes($_POST['page']) . "', '" . addslashes($_POST['title']) . "', '" . addslashes($_POST['eregi']) . "', '" . addslashes($_POST['msg']) . "');");
		
		transfer($config,'rules_edit.php','Rule Added');
		exit;
	}
}
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add Rule </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;">  <form name="form1" method="post" action="">
  <table width="70%" cellpadding="0" cellspacing="2" border="0">
    <tr>
      <td width="25%"><strong>Rule Title </strong></td>
      <td width="55%">:
        <input name="title" type="Text" class="textbox" id="id" style="width:60%" value=""></td>
    </tr>
    <tr>
      <td><strong>Rule Page </strong></td>
      <td>:
        <select name="page" id="page" style="width:60%">
		  <option>create_project.php</option>
          <option>board_post.php</option>
		  <option>bid.php</option>
       </select></td>
    </tr>
    <tr>
      ...
      <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><textarea name="eregi" rows="15" class="textbox" id="content" style="width:61%"></textarea></td>
          </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="7" valign="top">:</td>
            <td><textarea name="msg" rows="15" class="textbox" id="content" style="width:61%"></textarea></td>
          </tr>
      </table></td>
    </tr>
    <tr>
