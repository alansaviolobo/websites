...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Edit Job Categories</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="jobcat_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td height="30"><span class="style2"><a href="<?php echo  $PHP_SELF ?>?sortby=category_title&direction=<?php if($_GET['direction']=="ASC"){ echo "DESC"; }else{ echo "ASC"; } ?>&pageno=<?php echo $pageno?>" class="a2">Category Title </a></span></td>
      </tr>
      <tr bgcolor="#000000">
...
$query = "SELECT 1 FROM ".$config['db']['pre']."jobs_categories";
...
$query = "SELECT cat_id,cat_title FROM ".$config['db']['pre']."jobs_categories ORDER BY cat_title ".$limit;
...
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onclick="document.f1.action='jobcat_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
