...
if(isset($_POST['username']))
{
	...
	{
		$account_exists = check_account_exists($config,$_POST['email'],'buyer');
	...
	if($errors == 0)
	{
		...
		header("Location: buyer_edit.php");
		exit;
	}
}
...
<html>
<head>
<title><?php echo $config['site_title']; ?> Admin - Add <?php echo $lang['BUYERU']; ?></title>
...
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add <?php echo $lang['BUYERU']; ?></td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #CCCCCC;">
  <tr>
    <td align="center" bgcolor="#F6F6F6" style="padding:15px;"><form name="form1" method="post" action="buyer_add.php">
