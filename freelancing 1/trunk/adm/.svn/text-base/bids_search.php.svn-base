...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Bid Search </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<tr>
<td align="center" bgcolor="#F6F6F6" style="padding:15px;">  <form name="form1" method="get" action="bids_view.php">
  <table width="70%" cellpadding="0" cellspacing="2" border="0">
    <tr>
      <td width="25%"><strong>Project ID </strong></td>
      <td width="55%">:
        <input name="project" type="Text" class="textbox" id="project" style="width:60%" value=""></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
