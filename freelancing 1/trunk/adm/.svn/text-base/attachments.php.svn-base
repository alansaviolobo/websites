...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Edit Attachment Type(s)</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="attachments_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td height="30" bgcolor="#FF9900"><span class="rowheader">File Extension</span></td>
        <td height="30" bgcolor="#FF9900"><span class="rowheader">File Content Type</span></td>
        <td height="30" bgcolor="#FF9900"><span class="rowheader">File Max Size (bytes)</span></td>
      	<td width="150" height="30" bgcolor="#FF9900"><span class="rowheader">Options</span></td>
	  </tr>
      <tr bgcolor="#000000">
        <td height="1" style="padding:0px;" colspan="5"></td>
      </tr>
<?php
$count = 0;
$counter = 0;
...
$query = "SELECT 1 FROM ".$config['db']['pre']."attachments_types";
...
$query = "SELECT type_id,type_ext,type_content,max_size FROM ".$config['db']['pre']."attachments_types ".$limit;
...
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo $info['type_id']; ?>"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['type_id']; ?>"></td>
        <td height="25"><span class="style5"><?php echo $info['type_ext']; ?></span></td>
        <td height="25"><span class="style5"><?php echo $info['type_content']; ?></span></td>
        <td height="25"><span class="style5"><?php echo $info['max_size']; ?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['type_id'];?>" id="amenu<?php echo $info['type_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="attachments_edit.php?id=<?php echo $info['type_id'];?>">View/Edit Type</option>
                  <option value="attachments_delete.php?id=<?php echo $info['type_id'];?>">Delete Type</option>
                </select>
</td>
			  </tr>
			  </table>
...
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onClick="document.f1.action='attachments_edit.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
