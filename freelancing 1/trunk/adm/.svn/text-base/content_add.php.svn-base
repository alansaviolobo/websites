...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		mysql_query("INSERT INTO `".$config['db']['pre']."html` ( `html_id` , `html_type` , `html_title` , `html_content` ) VALUES ('" . addslashes($_POST['id']) . "', '" . addslashes($_POST['type']) . "', '" . addslashes($_POST['title']) . "', '" . addslashes($_POST['content']) . "');");
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
  <tr>
    <td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add Content</td>
  </tr>
  <tr>
    <td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
  </tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;">  <form name="form1" method="post" action="">
  <table width="90%" cellpadding="0" cellspacing="2" border="0">
    <tr>
      ...
      <td width="80%">:
        <input name="id" type="Text" class="textbox" id="id" style="width:60%" value="<?php if(isset($_POST['id'])){ echo $_POST['id']; } ?>" maxlength="8"></td>
    </tr>
    <tr>
      <td><strong>Page Title</strong></td>
      <td>:
        <input name="title" type="Text" class="textbox" id="title" style="width:60%" value="<?php if(isset($_POST['title'])){ echo $_POST['title']; } ?>"></td>
    </tr>
    <tr>
      <td><strong>Page Type</strong></td>
      <td>:
        <select name="type" class="textbox" id="type" style="width:60%">
    ...
    <tr>
      ...
      <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><textarea name="content" id="content" style="width:316px;height:200px;"><?php if(isset($_POST['content'])){ echo $_POST['content']; } ?></textarea>
<script>
