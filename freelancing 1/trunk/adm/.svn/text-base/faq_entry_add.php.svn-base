...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		mysql_query("INSERT INTO `".$config['db']['pre']."faq_entries` ( `faq_id` , `faq_weight` , `faq_title` , `faq_content` ) VALUES ('', '0', '" . addslashes($_POST['title']) . "', '" . addslashes($_POST['content']) . "');");
		
		transfer($config,'faq_entry_edit.php','Faq Entry Added');
		exit;
	}
}
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add FAQ Entry </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;">  <form name="form1" method="post" action="">
  <table width="70%" cellpadding="0" cellspacing="2" border="0">
    <tr>
      <td width="25%"><strong>FAQ Title </strong></td>
      <td width="55%">:
        <input name="title" type="Text" class="textbox" id="title" style="width:60%" value=""></td>
    </tr>
    <tr>
      <td valign="top"><strong>FAQ Content </strong></td>
      <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="7" valign="top">:</td>
            <td><textarea name="content" rows="15" class="textbox" id="content" style="width:61%;height:200px;"></textarea></td>
          </tr>
      </table></td>
    </tr>
    <tr>
