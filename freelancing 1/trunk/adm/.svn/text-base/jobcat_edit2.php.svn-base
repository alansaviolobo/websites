...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		if(isset($_POST['Submit']))
		{
			...
			{
				mysql_query("UPDATE `".$config['db']['pre']."jobs_categories` SET `cat_title` = '" . addslashes($_POST['title'][$value]) . "' WHERE `cat_id` = '" . addslashes($value) . "' LIMIT 1 ;");
			}
			
			transfer($config,'jobcat_edit.php','Job Category Edited');
			exit;
		}
	}
}
...
<html>
<head>
	<title><?php echo $config['site_title']; ?> Admin - Edit Job Categories</title>
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5"><span class="heading">Edit Job Categories</span></td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<?
$count = 0;
$sql = "SELECT cat_id,cat_title FROM ".$config['db']['pre']."jobs_categories ";
...
<table width="70%" cellpadding="0" cellspacing="2" border="0">
  ...
  <tr>
    ...
    <td>:
        <input name="title[<?php echo $info['cat_id'];?>]" type="Text" class="textbox" style="width:316px" value="<?php echo stripslashes($info['cat_title']);?>"></td>
  </tr>
</table>
<br><br>
<?
