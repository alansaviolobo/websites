...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="buyer_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."buyers";
...
$query = "SELECT buyer_id,buyer_username,buyer_email,buyer_name,buyer_rating,buyer_reviews FROM ".$config['db']['pre']."buyers ".$limit;
...
while ($info = @mysql_fetch_array($query_result))
{
	...
	if($info['buyer_rating'] == 0)
	{
		$rating = "Not rated yet";
	}
	ELSE
	{
		$rating = $info['buyer_rating'];
	}
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo $info['buyer_id'];?>"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['buyer_id'];?>"></td>
        <td width="100" height="25"><span class="style5"><?php echo $info['buyer_username'];?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['buyer_name']);?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['buyer_email']);?></span></td>
        <td height="25"><span class="style5"><?php echo $rating;?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['buyer_id'];?>" id="amenu<?php echo $info['buyer_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="buyer_edit2.php?id=<?php echo $info['buyer_id'];?>">View/Edit <?php echo $lang['BUYERU']; ?></option>
                  <option value="buyer_delete.php?id=<?php echo $info['buyer_id'];?>">Delete <?php echo $lang['BUYERU']; ?></option>
                </select>
</td>
			  </tr>
			  </table>
...
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onClick="document.f1.action='buyer_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
