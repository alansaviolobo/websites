...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Edit FAQ Categories </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="faq_cat_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td width="100" height="30"><span class="rowheader">Category ID</span></td>
        <td height="30" bgcolor="#FF9900"><span class="rowheader">Category Title</span></td>
      </tr>
      <tr bgcolor="#000000">
        <td height="1" colspan="3" style="padding:0px;"></td>
      </tr>
      <?php
$count = 0;
$counter = 0;
...
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo $info['cat_id']; ?>"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['cat_id']; ?>"></td>
        <td height="25"><span class="style5"><?php echo $info['cat_id']; ?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['cat_title']);?></span></td>
      </tr>
      <?
}
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onclick="document.f1.action='faq_cat_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
