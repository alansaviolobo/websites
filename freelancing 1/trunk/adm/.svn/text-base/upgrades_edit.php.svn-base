...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #CCCCCC;">
  <tr>
    <td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
        <form action="upgrades_delete.php" method="post" name="f1" id="f1">
          <div align="right"> <br>
          </div>
          <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr bgcolor="#FF9900">
              ...
              <td height="30"><span class="rowheader">Name</span></td>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."subscriptions";
...
$query = "SELECT sub_id,sub_title FROM ".$config['db']['pre']."subscriptions ".$limit;
...
?>
            <tr bgcolor="<?php echo $colour; ?>">
              <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo stripslashes($info['sub_title']);?>">
                  <input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['sub_id'];?>"></td>
              <td height="25"><span class="style5"><?php echo stripslashes($info['sub_title']);?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['sub_id'];?>" id="amenu<?php echo $info['sub_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="upgrades_edit2.php?id=<?php echo $info['sub_id'];?>">View/Edit Upgrade</option>
                  <option value="upgrades_delete.php?id=<?php echo $info['sub_id'];?>">Delete Upgrade</option>
                </select>
</td>
			  </tr>
			  </table>
...
?>
          ...
          <div align="left"> <br>
              <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                  <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onClick="document.f1.action='upgrades_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
