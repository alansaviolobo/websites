...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		...
		{
			$count = 0;
			$sql = "DELETE FROM `".$config['db']['pre']."jobs_types` ";
			...
			transfer($config,'jobtype_edit.php','Job Types Deleted');
			exit;
		}
	}
}
...
<html>
<head>
	<title><?php echo $config['site_title']; ?> Admin - Delete Job Types</title>
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Delete Job Types</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
  ...
  <form action="" method="post" name="f1" id="f1">
          <div align="center" class="style6">            
            <table  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><span class="style6"><span class="style7">Are you sure you want to delete the following Job Types?</span><br>
                  </span><br>
<ul>
<?php 
$count = 0;
$sql = "SELECT type_title,type_id FROM ".$config['db']['pre']."jobs_types ";
...
{
	echo "<li>" . stripslashes($info['type_title']) . "</li>";
	echo "<input type=\"hidden\" name=\"list[]\" id=\"list[]\" value=\"" . $info['type_id'] . "\">";
}
?>
</ul>
                  <br>
