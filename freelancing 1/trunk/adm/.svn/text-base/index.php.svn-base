...
$member_count = ($provider_count+$buyer_count);
?>
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading">Welcome to <?php echo $config['site_title']; ?> Admin </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<tr>
  <td bgcolor="#F6F6F6" style="padding:15px;"><table cellpadding="0" cellspacing="2" border="0">
    <tr>
      <td width="150"><strong>Running Version </strong></td>
      <td>:
          <?php echo $config['version'];?></td>
    </tr>
    <tr>
      <td><strong>Current Members </strong></td>
      <td>:
          <?php echo $member_count;?></td>
    </tr>
    <tr>
      <td><strong>Language </strong></td>
      <td>:
          <?php echo ucwords($config['lang']);?></td>
    </tr>
  </table></td>
</tr>
</table>
