...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		...
		{
			$count = 0;
			$sql = "DELETE FROM `".$config['db']['pre']."faq_cats` ";
			...
			transfer($config,'faq_cat_edit.php','FAQ Category Deleted');
			exit;
		}
	}
}
  ...
  <form action="" method="post" name="f1" id="f1">
          <div align="center" class="style6">            
            <table  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><span class="style6"><span class="style7">Are you sure you want to delete the following FAQ Categories?</span><br>
                  </span><br>
<ul>
<?php 
$count = 0;
$sql = "SELECT cat_title,cat_id FROM ".$config['db']['pre']."faq_cats ";
