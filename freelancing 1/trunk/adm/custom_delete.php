...
<html>
<head>
<title><?php echo $config['site_title']; ?> Admin - Delete Custom Fields</title>
...
<tr>
<td class="heading"><img src="images/icon_editrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Delete Custom Fields</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
        ...
        <form action="" method="post" name="f1" id="f1">
          <div align="center" class="style6">
            <table  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
<span class="style6"><span class="style7">Are you sure you want to delete the following custom fields?</span><br></span><br>
<ul>
<?php 
$count = 0;
$sql = "SELECT custom_id,custom_title FROM ".$config['db']['pre']."custom_fields ";
...
{
	echo "<li>" . $info['custom_title'] . "</li>";
	echo "<input type=\"hidden\" name=\"list[]\" id=\"list[]\" value=\"" . $info['custom_id'] . "\">";
}
?>
</ul>
                  <br>
