...
{
	mysql_query("INSERT INTO `".$config['db']['pre']."admins` ( `admin_id` , `username` , `password` ) VALUES ('', '".addslashes($_POST['username'])."', '".addslashes(md5($_POST['password']))."');");
...
<html>
<head>
<title><?php echo $config['site_title']; ?> Admin - Add Admin</title>
...
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add Admin </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #CCCCCC;">
  <tr>
    <td align="center" bgcolor="#F6F6F6" style="padding:15px;"><form name="form1" method="post" action="admin_add.php">
        <table width="70%" cellpadding="0" cellspacing="2" border="0">
          ...
          <tr>
            ...
            <td width="55%">:
                <input name="password" type="password" class="textbox" id="password" style="width:60%" value=""></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
