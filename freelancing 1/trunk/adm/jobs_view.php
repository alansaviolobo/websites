...
<html>
<head>
	<title><?php echo $config['site_title']; ?> Admin - View Jobs</title>
...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="jobs_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td width="100" height="30"><span class="rowheader">Job ID</span></td>
        <td width="200" height="30" bgcolor="#FF9900"><span class="rowheader">Job Title</span></td>
        <td height="30"><span class="rowheader">Job Type</span></td>
        <td height="30"><span class="rowheader">Job Category</span></td>
      </tr>
      <tr bgcolor="#000000">
...
$query = "SELECT 1 FROM ".$config['db']['pre']."jobs";
...
{
	$cats[$info['cat_id']] = $info['cat_title'];
}
...
while ($info = @mysql_fetch_array($query_result))
{
	$types[$info['type_id']] = $info['type_title'];
}

$query = "SELECT job_id,job_title,job_category,job_type FROM ".$config['db']['pre']."jobs ".$limit;
$query_result = mysql_query($query);
while ($info = @mysql_fetch_array($query_result))
{
	$counter++;
...
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['job_id'];?>"></td>
        <td width="100" height="25"><span class="style5"><?php echo $info['job_id'];?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['job_title']);?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($types[$info['job_type']]);?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($cats[$info['job_category']]);?></span></td>
      </tr>
      <?
}
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onclick="document.f1.action='jobs_edit.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
