...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #CCCCCC;">
  <tr>
    <td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
        <form action="custom_delete.php" method="post" name="f1" id="f1">
          <div align="right"> <br>
          </div>
          <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr bgcolor="#FF9900">
              ...
              <td width="150" height="30"><span class="rowheader">Field Title</span></td>
              <td height="30"><span class="rowheader">Page</span></td>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."custom_fields";
...
$query = "SELECT custom_id,custom_title,custom_page FROM ".$config['db']['pre']."custom_fields ".$limit;
...
?>
            <tr bgcolor="<?php echo $colour; ?>">
              <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo $info['custom_title'];?>">
                  <input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['custom_id'];?>"></td>
              <td height="25"><span class="style5"><?php echo stripslashes($info['custom_title']);?></span></td>
              <td height="25"><span class="style5"><?php if($info['custom_page'] == 'create_project'){ echo 'Create Project'; } elseif($info['custom_field'] == 'profile_buyer'){ echo 'Buyer Profile'; } elseif($info['custom_page'] == 'profile_provider'){ echo 'Provider Profile'; } ?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['custom_id'];?>" id="amenu<?php echo $info['custom_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="custom_edit.php?id=<?php echo $info['custom_id'];?>">View/Edit Field</option>
                  <option value="custom_delete.php?id=<?php echo $info['custom_id'];?>">Delete Field</option>
                </select>
</td>
			  </tr>
			  </table>
...
?>
          ...
          <div align="left"> <br>
              <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                  <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onClick="document.f1.action='custom_edit.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
