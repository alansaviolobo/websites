...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		mysql_query("INSERT INTO `".$config['db']['pre']."faq_cats` ( `cat_id` , `cat_pos` , `cat_title` ) VALUES ('', '0', '" . addslashes($_POST['title']) . "');");
		
		transfer($config,'faq_cat_edit.php','Faq Category Added');
		exit;
	}
}
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add FAQ Category</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
