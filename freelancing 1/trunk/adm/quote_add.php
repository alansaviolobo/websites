...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		mysql_query("INSERT INTO `".$config['db']['pre']."quotes` ( `quote_id` , `quote_comment` , `quote_author` ) VALUES ('', '" . addslashes($_POST['quote']) . "', '" . addslashes($_POST['author']) . "');");
		
		transfer($config,'quotes_edit.php','Quote Added');
		exit;
	}
}
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_addrule.gif" width="19" height="24" alt="" align="absmiddle" hspace="5">Add Quote </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
  ...
  <tr>
    ...
    <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><textarea name="quote" class="textbox" style="width:61%;height:100px;"></textarea></td>
        </tr>
    </table></td>
  </tr>
    <tr>
      ...
      <td width="55%">:
        <input name="author" type="text" class="textbox" id="author" style="width:60%" value=""></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
