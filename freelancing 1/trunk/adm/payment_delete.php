...
if(isset($_POST))
{
	if(count($_POST) > 1)
	{
		...
		{
			$count = 0;
			$sql = "DELETE FROM `".$config['db']['pre']."payments` ";
			...
			transfer($config,'payment_settings.php','Rules Deleted');
			exit;
		}
	}
}
...
<html>
<head>
	<title><?php echo $config['site_title']; ?> Admin - Delete Payment Processors</title>
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td class="heading"><img src="images/icon_manage.gif" width="26" height="25" alt="" align="absmiddle" hspace="5">Delete Payment Processors</td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
  ...
  <form action="" method="post" name="f1" id="f1">
          <div align="center" class="style6">            
            <table  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><span class="style6"><span class="style7">Are you sure you want to delete the following payment processors?</span><br>
                  </span><br>
<ul>
<?php 
$count = 0;
$sql = "SELECT payment_title,payment_id FROM ".$config['db']['pre']."payments ";
...
{
	echo "<li>" . stripslashes($info['payment_title']) . "</li>";
	echo "<input type=\"hidden\" name=\"list[]\" id=\"list[]\" value=\"" . $info['payment_id'] . "\">";
}
?>
</ul>
                  <br>
