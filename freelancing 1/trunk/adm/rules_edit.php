  ...
  <form action="rules_delete.php" method="post" name="f1" id="f1">
    ...
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td width="130" height="30"><span class="rowheader">Rule Page</span></td>
        <td width="160" height="30" bgcolor="#FF9900"><span class="rowheader">Rule Title</span></td>
        <td height="30"><span class="rowheader">Rule</span></td>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."rules";
...
$query = "SELECT rule_id,page,rule_title,rule_eregi FROM ".$config['db']['pre']."rules ".$limit;
...
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo $info['rule_title'];?>"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['rule_id'];?>"></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['page']);?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['rule_title']);?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['rule_eregi']);?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['rule_id'];?>" id="amenu<?php echo $info['rule_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="rule_edit.php?id=<?php echo $info['rule_id'];?>">View/Edit Rule</option>
                  <option value="rules_delete.php?id=<?php echo $info['rule_id'];?>">Delete Rule</option>
                </select>
</td>
			  </tr>
			  </table>
...
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onclick="document.f1.action='rule_edit.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
