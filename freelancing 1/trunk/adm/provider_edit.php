...
<td align="center" bgcolor="#F6F6F6" style="padding:15px;"><div align="right">
  <form action="provider_delete.php" method="post" name="f1" id="f1">
    <div align="right">      <br>
    </div>
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr bgcolor="#FF9900">
        ...
        <td width="100" height="30"><span class="rowheader">Username</span></td>
        <td width="130" height="30" bgcolor="#FF9900"><span class="rowheader">Name/Company</span></td>
        <td width="180" height="30"><span class="rowheader">Email Address</span></td>
        <td height="30" class="a2"><span class="rowheader">Rating</span></td>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."providers";
...
$query = "SELECT provider_id,provider_username,provider_email,provider_name,provider_rating,provider_reviews FROM ".$config['db']['pre']."providers ".$limit;
...
while ($info = @mysql_fetch_array($query_result))
{
	...
	if($info['provider_rating'] == 0)
	{
		$rating = "Not rated yet";
	}
	ELSE
	{
		$rating = $info['provider_rating'];
	}
?>
      <tr bgcolor="<?php echo $colour; ?>">
        <td width="50" height="25" align="center"><input type="hidden" name="titles[]" id="titles[]" value="<?php echo $info['provider_id'];?>"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['provider_id'];?>"></td>
        <td width="100" height="25"><span class="style5"><?php echo $info['provider_username'];?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['provider_name']);?></span></td>
        <td height="25"><span class="style5"><?php echo stripslashes($info['provider_email']);?></span></td>
        <td height="25"><span class="style5"><?php echo $rating;?></span></td>
			  <td height="25">
			  <table border="0" cellpadding="0" cellspacing="0"><tr><td>
                <select name="amenu<?php echo $info['provider_id'];?>" id="amenu<?php echo $info['provider_id'];?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
				  <option value="">Options</option>
                  <option value="provider_edit2.php?id=<?php echo $info['provider_id'];?>">View/Edit <?php echo $lang['PROVIDERU']; ?></option>
                  <option value="provider_delete.php?id=<?php echo $info['provider_id'];?>">Delete <?php echo $lang['PROVIDERU']; ?></option>
                </select>
</td>
			  </tr>
			  </table>
...
?>
    ...
    <div align="left">
      ...
      <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
        <tr>
          <td width="200" valign="middle">With Selected:&nbsp;<a href="#" onClick="document.f1.action='provider_edit2.php'; document.f1.submit();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
