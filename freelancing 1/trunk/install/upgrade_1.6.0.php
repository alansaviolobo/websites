...
{
	echo 'Before you run an upgrade it is recomended that you backup your '.$config['site_title'].' database<br><Br>Are you sure you want to upgrade your '.$config['site_title'].' installation from '.$config['version'].' to '.$install_version.'?<br><br><a href="upgrade_1.6.0.php?install=1">Yes do it</a>';
}
else
{
	ignore_user_abort(1);
	...
	@mysql_query("ALTER TABLE `".$config['db']['pre']."projects` ADD `project_custom_fields` MEDIUMTEXT NOT NULL ;");
	
	@mysql_query("ALTER TABLE `".$config['db']['pre']."projects` ADD `project_custom_values` MEDIUMTEXT NOT NULL ;");

	@mysql_query("CREATE TABLE `".$config['db']['pre']."custom_fields` (  `custom_id` int(11) unsigned NOT NULL auto_increment,  `custom_page` varchar(60) NOT NULL default '',  `custom_name` varchar(40) NOT NULL default '',  `custom_title` varchar(100) NOT NULL default '',  `custom_type` varchar(40) NOT NULL default '',  `custom_content` varchar(20) NOT NULL default '',  `custom_min` int(11) unsigned NOT NULL default '0',  `custom_max` int(11) unsigned NOT NULL default '0',  `custom_required` tinyint(1) unsigned NOT NULL default '0',  `custom_options` mediumtext NOT NULL,  `custom_default` varchar(200) NOT NULL default '',  PRIMARY KEY  (`custom_id`),  KEY `custom_page` (`custom_page`));");
